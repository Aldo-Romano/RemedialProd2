    ...
    <form id="form1" runat="server">
       ...
       <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
        Registrar Carrera</button>
         ...
         &nbsp;&nbsp;&nbsp;
         <asp:Button ID="Button4" class="btn btn-primary" runat="server" Text="Carreras" Height="29px" Width="101px" OnClick="Button4_Click"/>
         <br />
        ...
        <center>
            ...
            <SortedDescendingHeaderStyle BackColor="#00547E" />
             ...
             <br />
            <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Italic="True" Font-Names="Bodoni MT Condensed" Font-Size="Large" Text="Programa Educativo Seleccionada: "></asp:Label>
&nbsp;&nbsp;&nbsp;
            <asp:Label ID="lbProgramaEd" runat="server" Text="________________"></asp:Label>
&nbsp;&nbsp;&nbsp;
         <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal1">
          Actualizar Programa Educativo</button>
         <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true">
         <div class="modal-dialog">
         <div class="modal-content">
         <div class="modal-header">
         <h5 class="modal-title" id="exampleModalLabe1l">Bitacora | Programa Educativo </h5>
         <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
         </div>
         <div class="modal-body">
         <div class="mb-3">
         <asp:Label ID="Label5" runat="server"  class="form-label" Text="Programa Educativo:"></asp:Label>
         <asp:TextBox ID="txtProgramaEDA" runat="server" class="form-control"></asp:TextBox>
         <br />
         <asp:Label ID="Label6" runat="server"  class="form-label" Text="Carrera Seleccionada:"></asp:Label>
         &nbsp;&nbsp;&nbsp;
         <asp:Button ID="Button5" class="btn btn-primary" runat="server" Text="Carreras" Height="29px" Width="101px" OnClick="Button5_Click"/>
         <br />
         <asp:DropDownList ID="dropProgramaEdActualizar" runat="server"></asp:DropDownList>
          <br />
